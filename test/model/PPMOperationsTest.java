...
public class PPMOperationsTest {
    ...
    public void testImageBrighten() throws IOException {
        ...
        Image loadedSampleImage = ImageUtil.readPPM("images/sample-test-brighter.ppm", "sample-test-brighter");
        assertEquals(sampleImage, loadedSampleImage);
    }
    ...
    public void testImageDarken() throws IOException {
        ...
        Image loadedSampleImage = ImageUtil.readPPM("images/sample-test-darker.ppm", "sample-test-darker");
        assertEquals(sampleImage, loadedSampleImage);
    }
    ...
    public void testVerticalFlipForImage() throws IOException {
        ...
        Image loadedSampleImage = ImageUtil.readPPM("images/sample-test-vertical.ppm", "sample-test-vertical");
        assertEquals(sampleImage, loadedSampleImage);
    }
    ...
    public void testHorizontalFlipForImage() throws IOException {
        ...
        Image loadedSampleImage = ImageUtil.readPPM("images/sample-test-horizontal.ppm", "sample-test-horizontal");
        assertEquals(sampleImage, loadedSampleImage);
    }
    ...
    public void testVerticalFlipForHorizontallyFlippedImage() throws IOException {
        ...
        controller.go(in);
        Image sampleImage = ImageUtil.readPPM("images/sample-horizontal-vertical.ppm", "sample-horizontal-vertical");
        Image loadedSampleImage = ImageUtil.readPPM("images/sample-test-horizontal-vertical.ppm", "sample-test-horizontal-vertical");
        assertEquals(sampleImage, loadedSampleImage);
    }
    ...
    public void testHorizontalFlipForVerticallyFlippedImage() throws IOException {
        ...
        controller.go(in);
        Image sampleImage = ImageUtil.readPPM("images/sample-vertical-horizontal.ppm", "sample-vertical-horizontal");
        Image loadedSampleImage = ImageUtil.readPPM("images/sample-test-vertical-horizontal.ppm", "sample-test-vertical-horizontal");
        assertEquals(sampleImage, loadedSampleImage);
    }
    ...
    public void testHorizontalFlipForHorizontallyFlippedImage() throws IOException {
        ...
        controller.go(in);
        Image sampleImage = ImageUtil.readPPM("images/sample-horizontal-horizontal.ppm", "sample-horizontal-horizontal");
        Image loadedSampleImage = ImageUtil.readPPM("images/sample-test-horizontal-horizontal.ppm", "sample-test-horizontal-horizontal");
        assertEquals(sampleImage, loadedSampleImage);
    }
    ...
    public void testVerticalFlipForVerticallyFlippedImage() throws IOException {
        ...
        controller.go(in);
        Image sampleImage = ImageUtil.readPPM("images/sample-vertical-vertical.ppm", "sample-vertical-vertical");
        Image loadedSampleImage = ImageUtil.readPPM("images/sample-test-vertical-vertical.ppm", "sample-test-vertical-vertical");
        assertEquals(sampleImage, loadedSampleImage);
    }
    ...
    public void testGreyscaleForValueComponent() throws IOException {
        ...
        controller.go(in);
        Image sampleImage = ImageUtil.readPPM("images/sample-greyscale-value.ppm", "sample-greyscale-value");
        Image loadedSampleImage = ImageUtil.readPPM("images/sample-test-greyscale-value.ppm", "sample-test-greyscale-value");
        assertEquals(sampleImage, loadedSampleImage);
    }
    ...
    public void testGreyscaleForIntensityComponent() throws IOException {
        ...
        controller.go(in);
        Image sampleImage = ImageUtil.readPPM("images/sample-greyscale-intensity.ppm", "sample-greyscale-intensity");
        Image loadedSampleImage = ImageUtil.readPPM("images/sample-test-greyscale-intensity.ppm", "sample-test-greyscale-intensity");
        assertEquals(sampleImage, loadedSampleImage);
    }
    ...
    public void testGreyscaleForLumaComponent() throws IOException {
        ...
        controller.go(in);
        Image sampleImage = ImageUtil.readPPM("images/sample-greyscale-luma.ppm", "sample-greyscale-luma");
        Image loadedSampleImage = ImageUtil.readPPM("images/sample-test-greyscale-luma.ppm", "sample-test-greyscale-luma");
        assertEquals(sampleImage, loadedSampleImage);
    }
    ...
    public void testGreyscaleForRedComponent() throws IOException {
        ...
        controller.go(in);
        Image sampleImage = ImageUtil.readPPM("images/sample-greyscale-red.ppm", "sample-greyscale-red");
        Image loadedSampleImage = ImageUtil.readPPM("images/sample-test-greyscale-red.ppm", "sample-test-greyscale-red");
        assertEquals(sampleImage, loadedSampleImage);
    }
    ...
    public void testGreyscaleForGreenComponent() throws IOException {
        ...
        controller.go(in);
        Image sampleImage = ImageUtil.readPPM("images/sample-greyscale-green.ppm", "sample-greyscale-green");
        Image loadedSampleImage = ImageUtil.readPPM("images/sample-test-greyscale-green.ppm", "sample-test-greyscale-green");
        assertEquals(sampleImage, loadedSampleImage);
    }
    ...
    public void testGreyscaleForBlueComponent() throws IOException {
        ...
        controller.go(in);
        Image sampleImage = ImageUtil.readPPM("images/sample-greyscale-blue.ppm", "sample-greyscale-blue");
        Image loadedSampleImage = ImageUtil.readPPM("images/sample-test-greyscale-blue.ppm", "sample-test-greyscale-blue");
        assertEquals(sampleImage, loadedSampleImage);
    }
    ...
    public void testToGiveImageARedTint() throws IOException {
        ...
        Image loadedSampleImage = ImageUtil.readPPM("images/sample-test-red-tint.ppm", "sample-test-red-tint");
        assertEquals(sampleImage, loadedSampleImage);
    }
