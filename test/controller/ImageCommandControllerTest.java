   ...
   // @Test
    ...
    IOException {
        ...
        assertEquals("ImageType: ppm identifier: sample" +
                ...
                "save: identifier of the image to be saved: sample-vertical-horizontal", modelLog.toString());
    }
    ...
    IOException {
        ...
        assertEquals("ImageType: ppm identifier: sample" +
                ...
                "save: identifier of the image to be saved: sample-horizontal-vertical", modelLog.toString());
    }
    ...
    IOException {
      ...
      AppController controller = new ImageCommandController(model, view);
        ...
        assertEquals("ImageType: ppm identifier: sample" +
                ...
                "save: identifier of the image to be saved: sample-vertical-vertical", modelLog.toString());
    }
    ...
    public void testHorizontalFlipWhenImageIsHorizontallyFlippedWhenCorrectParams()
      ...
      AppController controller = new ImageCommandController(model, view);
        ...
        assertEquals("ImageType: ppm identifier: sample" +
                ...
                "save: identifier of the image to be saved: sample-horizontal-horizontal", modelLog.toString());
    }
    ...
    public void testGreyscaleForValueCorrectParams() throws IOException {
      ...
      AppController controller = new ImageCommandController(model, view);
        ...
        controller.run(in);
        assertEquals("ImageType: ppm identifier: sample" +
                        "component: value identifier: sample " +
                        "new identifier: sample-greyscale-value" +
    ...
    public void testGreyscaleForLumaCorrectParams() throws IOException {
      ...
      AppController controller = new ImageCommandController(model, view);
        ...
        controller.run(in);
        assertEquals("ImageType: ppm identifier: sample" +
                        "component: luma identifier: sample " +
                        "new identifier: sample-greyscale-luma" +
    ...
    public void testGreyscaleForIntensityCorrectParams() throws IOException {
      ...
      AppController controller = new ImageCommandController(model, view);
        ...
        controller.run(in);
        assertEquals("ImageType: ppm identifier: sample" +
                        "component: intensity identifier: sample " +
                        "new identifier: sample-greyscale-intensity" +
    ...
    public void testGreyscaleForRedComponentCorrectParams() throws IOException {
      ...
      AppController controller = new ImageCommandController(model, view);
        ...
        controller.run(in);
        assertEquals("ImageType: ppm identifier: sample" +
                        "component: red identifier: sample " +
                        "new identifier: sample-greyscale-red" +
    ...
    public void testGreyscaleForGreenComponentCorrectParams() throws IOException {
      ...
      AppController controller = new ImageCommandController(model, view);
        ...
        controller.run(in);
        assertEquals("ImageType: ppm identifier: sample" +
                        "component: green identifier: sample " +
                        "new identifier: sample-greyscale-green" +
    ...
    public void testRGBSplitCorrectParams() throws IOException {
      ...
      AppController controller = new ImageCommandController(model, view);
        ...
        assertEquals("ImageType: ppm identifier: sample" +
                ...
                "component: blue identifier: sample new identifier: sample-green", modelLog.toString());
    }
